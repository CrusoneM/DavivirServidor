			...
			<div id="header-wrap" style="background-color: #ed3529  ">
				...
				<div class="clearfix">
					...
					<div id="logo" style="height: 65px; margin: 0%30px">
						<a href="/" class="standard-logo" data-dark-logo="images/logo-dark.png"><img style="max-width: : 45px;" src="images/logo.png" alt="Davivir Logo"></a>
						<a href="/" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img style="max-width: : 45px;;" src="images/logo.png" alt="Davivir Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu">
						...
						<ul>
							...
							<li><a style="border:1px solid" class="weight-light" href="contactanos"><div>COTIZA YA</div></a></li>
