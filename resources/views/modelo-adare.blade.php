...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
			...
			<div class="">
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide" style="background-image: url('images/desarrollo-sanpatricio/Adare/fachada.jpg'); background-position: center center; background-size: cover;">
							<div class="slider-title-modelos row nomargin col-xl-7 col-lg-9 col-md-11">
								
								<div class="col-2" id="img-header" style="height: 100%">
									<img src="images/desarrollo-sanpatricio/logo.png">
								</div>
								<div id="text-header" class="col-9">
									<h1 class="nomargin text-left" style="color: white; "><strong> COLINAS DE SAN PATRICIO</strong></h>
									<h2 class="nobottommargin text-left" style="color: white; margin-top: -5px"><strong>ADARE</strong></h2>
									<h2 class="nomargin text-left" style="position: absolute; bottom: 20px" >
										<strong class="weight-light" style="color: white">Desde</strong>
										<strong class="weight-bold" style="color: white">$574,500.00 *</strong>
									</h2>
								</div>
		...
		<section >
			<div id="header-mobil" class="header-mobil-desarrollo" style="		
			background: url('images/desarrollo-sanpatricio/Adare/fachada.jpg') center center no-repeat!important; 
			...
			">			
				...
				<div class="col-12  text-center desarrollo-mobil">	
					<div class="col-10 offset-1  ">
						<img src="images/desarrollo-sanpatricio/logo.png" style="max-width: 35%">
						<h1 class="nomargin" style="color: white; ">COLINAS DE</h1>
						<h1 class="nomargin" style="color: white; padding-bottom: 10px">SAN PATRICIO</h1>
						<h4 class="color-white text-md-left text-center" style="color: white; ">
						Colinas de San Patricio es el nuevo desarrollo de Davivir en el oriente de la ciudad. Ven, conoce y entérate por qué este desarrollo será tan especial y único!
						</h4 >
					</div>
				</div>
		</section>
		...
		<section id="content">
			...
			<div class="col-lg-12  col-padding">
				<div>
					<h2 class="bottommargin-lg text-center" style="color: #555;">
						<strong class="weight-light ">CONOCE</strong>
						<strong class="weight-bold ">NUESTRO</strong>
						<strong class="weight-light ">MODELO</strong>
						<strong class="weight-bold ">COLINAS DE SAN PATRICIO ADARE</strong>
					</h2>
				</div>
				<div id="oc-portfolio" class="owl-carousel portfolio-carousel carousel-widget" data-margin="20" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="3" data-items-xl="3">

						<div class="oc-item muestras-modelo">
							<div class="iportfolio">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="images/desarrollo-sanpatricio/Adare/1.jpg" alt="Open Imagination">
									</a>
									<div class="portfolio-overlay">
										<a href="images/desarrollo-sanpatricio/Adare/1.jpg" class=" center-icon" data-lightbox="image"><i class="icon-link color-red"></i></a>
						...
						<div class="oc-item muestras-modelo">
							<div class="iportfolio">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="images/desarrollo-sanpatricio/Adare/2.jpg" alt="Open Imagination">
									</a>
									<div class="portfolio-overlay">
										<a href="images/desarrollo-sanpatricio/Adare/2.jpg" class="center-icon" data-lightbox="image"><i class="icon-link color-red"></i></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="oc-item muestras-modelo">
							<div class="iportfolio">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="images/desarrollo-sanpatricio/Adare/3.jpg" alt="Open Imagination">
									</a>
									<div class="portfolio-overlay">
										<a href="images/desarrollo-sanpatricio/Adare/3.jpg" class="center-icon" data-lightbox="image"><i class="icon-link color-red"></i></a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="col-lg-12 row nomargin col-paddingnobottom">

				<div class="col-10 offset-1" style="border-top: 2px solid #555">

					<div class="col-md-10 topmargin-lg offset-md-1 bottommargin-lg-no text-center">
						<h4 class="weight-light">La vivienda Adare tiene una fantástica combinación de espacios generosos y bien diseñados, y al contar una recámara en planta baja, tienes toda la flexibilidad para adaptar la vivienda a lo que tú y tu familia necesitan. Adicionalmente, las recámaras de planta alta son amplias y tienen áreas de guardado generosas para que puedas guardar cómodamente todo lo que necesites.
						</h4>
			...
			<div class="row" style="padding: 3%5%">
				...
				<div class="nopadding col-md-3 offset-md-3 col-5 text-center">
					<h2 class="color weight-light"> TERRENO</h2>
					<h2 class="color weight-bold">75.00M <sup>2</sup></h2>
					
				</div>

				<div class="nopadding col-md-3 col-7 text-center">
					<h2 class="color weight-light"> CONSTRUCCIÓN</h2>
					<h2 class="color weight-bold">71.75M <sup>2</sup></h2>
			...
			<div class="row nomargin">
				...
				<div class="col-md-5 col-padding-sm" style="background: url('images/modelo-aleppo/contactanos.jpg') center center no-repeat; background-size: cover;">
					<h2 class="bottommargin text-center" style="color: white;">
						<strong class="weight-light">DESCARGA NUESTRO</strong>	
						<strong class="weight-bold">CATALOGO</strong>
					</h2>
			...
			<div class="col-12 row nomargin col-padding">


				<div class="col-12 col-padding-sm">
					<h2 class="text-center" style="color: #555;">
						<strong class="weight-light ">CONOCE</strong>
						<strong class="weight-bold ">LAS CARACTERÍSTICAS</strong>
					</h2>
					<h2 class="text-center" style="color: #555;">
						<strong class="weight-light ">DEL MODELO</strong>
						<strong class="weight-bold ">COLINAS DE SAN PATRICIO ADARE</strong>
					</h2>
				</div>
				    ...
				    <div class="col-md-4">
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/escuela.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/calle.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
                        ...
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/verde.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/comercial.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
                   	<div class="col-md-4">
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/deporte.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/regimen.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
                  	<div class="col-md-4">
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/parque.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/vias.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-box topmargin">
                                <div class="fbox-icon">
                                    <img  id="" src="images/modelo-aleppo/control.png">
                                </div>
                                <p class="color-blue text-left">Historial de memoria de 30 años sin perder registros si se desconecta de internet.</p>
                            </div>
                    </div>
			...
			<div class=" noleftmargin row norightmmargin " style="padding-bottom: 50px; background-color: #ececec">
				<div class="col-12 col-padding-sm">
					<h2 class="text-center" style="color: #555;">
						<strong class="weight-light ">PLANO</strong>
						<strong class="weight-bold ">ARQUITECTÓNICO</strong>
					</h2>
				</div>
				<div class="col-md-12  text-center div-plano" style="height: 55%">

					<img class="plano"  src="images/desarrollo-sanpatricio/Adare/plano.jpg">
			...
			<div class="col-12 row nomargin col-paddingnobottom" >

				<div class="col-12 nopadding bottommargin">
					<h2 class="text-center" style="color: #555;">
						<strong class="weight-light ">VISTA</strong>
						<strong class="weight-bold ">VIRTUAL</strong>
					</h2>

					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!4v1533182145548!6m8!1m7!1sCAoSLEFGMVFpcE96UlR2R0V0MXB5UDI5c29xTHR5TTZRU3Jqdzh5bHd3WjZiVTRF!2m2!1d21.884303894561!2d-102.24262496804!3f214.26135596126227!4f-22.298537781623594!5f0.7820865974627469" width="600" height="250" frameborder="0" style="border:2" allowfullscreen></iframe>
					</div>
				...
				<div class="col-12 bottommargin-lg">
					<h2 class="text-center" style="color: #555;">
						<strong class="weight-light ">CONOCE MÁS LOS</strong>
						<strong class="weight-bold ">MODELOS</strong>
						<strong class="weight-light ">COLINAS DE SAN PATRICIO</strong>
					</h2>

				</div>


					<div id="oc-portfolio" class="owl-carousel portfolio-carousel carousel-widget carrousel-modelos" data-margin="20" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="2" data-items-lg="2" data-items-xl="3" style="">

						<div class="oc-item modelo-item rounded-home" style="">

								<img src="images/desarrollo-sanpatricio/Adare/fachada.jpg">

							<div class="col-12">
								<h4 class="text-red weight-bold topmargin-sm bottommargin-sm">MODELO: ADARE</h4>

							</div>
							<div class="col-12" style="padding-bottom: 85px">
								<h6 class="nomargin">Terreno desde: 75.00 M2</h6>
						...
						<div class="oc-item modelo-item rounded-home" style="">
								...
								<img src="images/desarrollo-sanpatricio/Bray/fachada.jpg">

							<div class="col-12">
								<h4 class="text-red weight-bold topmargin-sm bottommargin-sm">MODELO: BRAY</h4>
						...
						<div class="oc-item modelo-item rounded-home" style="">
								...
								<img src="images/desarrollo-sanpatricio/Ennis/fachada.jpg">

							<div class="col-12">
								<h4 class="text-red weight-bold topmargin-sm bottommargin-sm">MODELO: ENNIS</h4>
			...
			<div class="col-lg-12 bg-gray row nomargin" style="width: 100%; padding: 75px 0px " >
				<div class="text-center col-md-12">
					<h2 class="text-color nomargin">
						...
						<strong class="weight-bold">NUESTROS EQUIPO</strong>
					...
					<div class="col-lg-6 norightmargin nomargin-mobile topmargin-lg row">
						...
						<div class="col-lg-6 topmargin-lg-mobile text-center text-lg-left" style="position: relative;">
							...
							<div class="modulo-contactanos">
								...
								<a href="davivir-contactanos.html"><img style="max-width: 40px" src="images/Mensaje.png"></a>
			...
			<div class="contenedor-escritorio-pc bg-gray" style="padding-top: 75px">
				<div class="text-center col-md-12" >
					<h2 class="text-color bottommargin-lg">
						<strong class="weight-light">CONOCE OTROS DE</strong>
						<strong class="weight-bold">NUESTROS DESARROLLOS</strong>
					</h2>
				</div>
				<div class="col-lg-12 row  nopadding residence nomargin">
					...
					<div class="col-xl-5 col-lg-6 col-md-7   content-descripcion-right" >
						...
						<div class="col-md-12">
							...
							<p class="text-red" style="margin-bottom: 15px">DESDE</p>
						</div>

						<div class="col-md-12 row nomargin nopadding text-center noabsolute">
							<div class="col-md-3 col-lg-3 col-xl-3 nopadding  cuadro-descripcion-res" style="height:  105px">
								<div class="nopadding">
							...
							<div class="col-md-3 col-lg-3 col-xl-3 nopadding cuadro-descripcion-res cuadro-descripcion-res-noborder" style="height:  105px">
								<div class="nopadding">
							...
							<div class="col-md-3 col-lg-3 col-xl-3 nopadding" style="height:  105px">
								<div class="nopadding">
			...
			<div class="padding-section bg-gray">
			<div class="contenedor-escritorio-mobil col-12">
				<div class="text-center col-md-12">
					...
					<div id="related-portfolio" class="owl-carousel owl-carousel-full portfolio-carousel portfolio-notitle portfolio-nomargin footer-stick carousel-widget" data-margin="0" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="1" data-items-md="3" data-items-lg="4" style="height: 900px">
