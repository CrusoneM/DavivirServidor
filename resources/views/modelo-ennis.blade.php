...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide" style="background-image: url('images/desarrollo-sanpatricio/Adare/fachada.jpg'); background-position: center center; background-size: cover;">
							<div class="slider-title-modelos row nomargin col-6">
								...
								<div id="text-header" class="col-9">
									<h1 class="nomargin text-left" style="color: white; "><strong> COLINAS  SAN PATRICIO</strong></h>
		...
		<section id="content">
			...
			<div class="col-lg-12  col-padding row nomargin">

				<div class="col-md-10 offset-md-1" style="border-top: 2px solid #555">

					<div class="col-10 topmargin-lg offset-1 bottommargin-lg-no text-center">
				...
				<div class=" col-md-3 offset-md-3 col-5 text-center">
			...
			<div class="row nomargin">
				<div class="col-md-7 row nomargin col-padding" style="background-color: #ececec;">
					...
					<div class="col-md-6 text-md-right text-center">
							<button type="button" class="btn btn-danger weight-light" style="margin-top: 12px; padding: 8px 40px;">VER MODELOS</button>
					</div>	
					<div class="col-md-6 text-md-left text-center">
							<button type="button" class="btn btn-danger weight-light" style="margin-top: 12px; padding: 8px 40px;">AGENDA TU VISITA</button>
					</div>	
			...
			<div class=" noleftmargin row norightmmargin " style="padding-bottom: 50px; background-color: #ececec">
				...
				<div class="col-md-12 text-center" style="height: 55%">

					<img style="width: 45%; height: 55%" src="images/desarrollo-sanpatricio/Adare/plano.jpg">
