...
<p>Para ti que disfrutas de la amplitud de espacios adecuada al tamaño de tu familia, la casa Cartagena de 3 recámaras es la mejor opción. Ven a conocer este nuevo modelo y enamórate de su excelente distribución y diseño interior!</p>
@endsection

@section('models-terreno', '67.50')
@section('models-construccion', '70.23')
{{-- /Models Section --}}
