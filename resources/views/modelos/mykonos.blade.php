...
<p>Pensada para familias jóvenes que quieren una casa que crezca con ellos. Este modelo te ofrece dos recámaras y la opción de crecerla hasta 3 recámaras y sala de TV para que así tu patrimonio se aumente a medida que tu familia lo necesita.</p>
@endsection

@section('models-terreno', '67.50')
@section('models-construccion', '41.78')
{{-- /Models Section --}}
