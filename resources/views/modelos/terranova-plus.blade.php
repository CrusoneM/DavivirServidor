...
@section('keywords', '')
@section('title', 'Terranova Plus')
{{--====== /Head ============--}}

{{--====== Header ============--}}
@section('header-img', '/images/modelos/terranova-plus/head.jpg')

@section('header-title-img', '/images/desarrollos/ibiza/logo.png')
@section('header-title', 'BOSQUES DE IBIZA')
@section('header-h4', 'TERRANOVA PLUS')
@section('header-price')
Desde <b>$500,000.00*</b>
@endsection
{{--====== /Header ============--}}
...
<a class="carousel-item" href="#one!"><img src="/images/modelos/terranova-plus/galeria-1.jpg"></a>
			    <a class="carousel-item" href="#two!"><img src="/images/modelos/terranova-plus/galeria-2.jpg"></a>
			    <a class="carousel-item" href="#two!"><img src="/images/modelos/terranova-plus/galeria-3.jpg"></a>
			    <a class="carousel-item" href="#two!"><img src="/images/modelos/terranova-plus/galeria-4.jpg"></a>
			    <a class="carousel-item" href="#two!"><img src="/images/modelos/terranova-plus/galeria-5.jpg"></a>
			    <a class="carousel-item" href="#two!"><img src="/images/modelos/terranova-plus/galeria-6.jpg"></a>
			    <a class="carousel-item" href="#two!"><img src="/images/modelos/terranova-plus/galeria-7.jpg"></a>
@endsection

@section('models-info')
{{-- <h3>¡CON <b>BONO DE DESCUENTO</b> DE HASTA <b> $45,000.00 PESOS!</b></h3> --}}
<p>Si tu familia está creciendo y deseas brindarle un espacio y privacidad a cada integrante, la Terranova Plus es la casa que se adapta conforme tu familia va creciendo. Este modelo de vivienda te permite crecer hasta cinco recámaras y por su lote de 90 m2 siempre tendrás garantizado un amplio espacio verde o cochera para dos autos.</p>
@endsection

@section('models-terreno', '90.00')
@section('models-construccion', '49.68')
{{-- /Models Section --}}
