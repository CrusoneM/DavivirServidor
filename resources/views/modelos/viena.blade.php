...
@section('models-slide')
				<a class="carousel-item" href="#one!"><img src="/images/modelos/viena/galeria-1.jpg"></a>
...
<p>El modelo Viena ofrece la solución de vivienda perfecta que tú y tu familia necesitan.</p>
@endsection

@section('models-terreno', '67.50')
@section('models-construccion', '61.92')
{{-- /Models Section --}}
